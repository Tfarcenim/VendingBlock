...
public class VendingSoundEvents {
    ...
    static {
        ResourceLocation res_sound_processed = new ResourceLocation(Vending.MODID, "sound_processed");
        ResourceLocation res_sound_forbidden = new ResourceLocation(Vending.MODID, "sound_forbidden");
        ResourceLocation res_safe_open = new ResourceLocation(Vending.MODID, "storage_open");
        ResourceLocation res_safe_close = new ResourceLocation(Vending.MODID, "storage_close");
